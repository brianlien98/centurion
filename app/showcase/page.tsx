      ...
      <main className="max-w-7xl mx-auto px-6">
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {products.map((prod) => (
              <div key={prod.id} className="bg-white border border-[#EFECE6] p-10 flex flex-col justify-between hover:shadow-md transition-all duration-300 group">
                ...
                <div className="pt-8 border-t border-[#F5F2EB] mt-10 flex justify-between items-center text-xs">
                  ...
                  {prod.image_url && (
                    <a href={prod.image_url} target="_blank" rel="noopener noreferrer" className="text-[#AF8943] hover:text-[#93702F] inline-flex items-center space-x-1 font-semibold">
                      <span>產品購買通道</span>
